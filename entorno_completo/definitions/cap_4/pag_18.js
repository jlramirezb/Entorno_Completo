    ...
    artifact_2: {
        ...
        conditions: {
            alphabetDiagram: {
                ...
                expression: '\\lfloor\\left(\\right)\\rfloor',
                xCoords: [
                    [
                        -3.15,-2, -1,-0.15,0.15,1,3.15                  ]
                ],
                            ...
                            nodes:
                                [
                                       ...
                                       
                                    {
                                        ...
                                        data: {
                                            label: "",
                                            condition: ["lfloorleft(right)rfloor","lfloorrfloor"],
...
let def = {
    example_artifact_1: {
        ...
        defaultinput: {
            screen: { defaultText: [{ textValue: 'n', disabled: true }, { textValue: '\\left\\lfloor n\\right\\rfloor', disabled: true }] },
            key: { defaultText: [{ textValue: '\\lfloor\\left(\\right)\\rfloor', disabled: true }] }
        },
        conditions: {
            screen: [[], [], []],
            //    key: []
