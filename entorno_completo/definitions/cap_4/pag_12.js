                            ...
                            nodes:
                                [
                                    
                                    {
                                        ...
                                        data: {
                                            label: "",
                                            condition: ["sqrt{placeholder{}}","sqrt{left(right)}","sqrt{}"],
                        ...
                        [
...

                            {
                                ...
                                data: {
                                    ...
                                    </math> ¿En qué intervalo está el x? `,
...
let def = {
    example_artifact_1: {
        ...
        defaultinput: {
            screen: { defaultText: [{ textValue: 'x', disabled: true }, { textValue: '\\sqrt{x}', disabled: true }] },
