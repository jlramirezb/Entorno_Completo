  ...
  artifact_1: {
    ...
    conditions: {
      screen: [
        ...
        ['lnleft(xright)=1.185600', 'lnleft(xright)=1.1856', 'lnleft(xright)=1.185599'],
        // ["x=3.27265022179","x=3.272","x=3.27"]
        ['x=3.272650', 'x=3.272651', 'x=3.27265', 'x=3.272647', 'x=3.272646']
  ...
  artifact_2: {
    ...
    conditions: {
      screen: [
        ...
        ['x-2=0.785398', 'x-2=0.785399', 'x-2=0.785397'],
        ['x=2.785398', 'x=2.785399', 'x=2.785397']
      ],
      key: [
        ['sqrt{left(right)}'],
        ['sin^{-1}left(right)'],
