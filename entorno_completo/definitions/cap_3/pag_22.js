  ...
  artifact_2: {
    ...
    conditions: {
      table: [
        ...
        ['1+6x-2-7x=0'],
        ['6x-7x+1-2=0', '6x-7x-2+1=0', '-7x+6x+1-2=0', '-7x+6x-2+1=0'],
        ['-x-1=0', '-1x-1=0', '-1left(xright)-1=0', '-1cdotx-1=0', "-x+left(-1right)"],
        [
          "-x=1", "-1x=1", "-1left(xright)=1", "-1cdotx=1", "-1x+left(1right)=0+left(1right)", "-1cdotx+left(1right)=0+left(1right)",
          "-1left(xright)+left(1right)=0+left(1right)"
        ],
        ['x=-1'],
      ],
    },
