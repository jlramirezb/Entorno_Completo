...
class Boards {
  ...
  createPoints(label, coord, open = false, fixed = true,){
    //{ x: -3, y: 0, visible: true, interactive: true },
    //[-2.2, 2.2, true, null, null, '#2196f3'],
    
    //const data  = {x:coord[0],y:coord[1],fixed, visible: true}
    const data = [coord[0], coord[1], true, label,fixed, open]
...
b0.createPoints('',[3.59,2.25],'#2196f3')
b0.createPoints('',[3.85,2.54],'#2196f3')
b0.createPoints('',[4.07,2.88],'#2196f3')

b0.createPoints('',[0,2],true,)
b0.createPoints('',[0,1],true)
b0.createPoints('',[0,-1],true)
b0.createPoints('',[0,-1.5],true)
...
b1.createPoints('',[2.06,2.16],'#2196f3')
b1.createPoints('',[2.13,2.39],'#2196f3')
b1.createPoints('',[2.17,2.67],'#2196f3')
b1.createPoints('',[-2.06,2.16],'#2196f3')
b1.createPoints('',[-2.13,2.39],'#2196f3')
b1.createPoints('',[-2.17,2.67],'#2196f3')
...
b2.createPoints('',[-2.61, 2.28],'#2196f3')
b2.createPoints('',[-2.76,2.39],'#2196f3')
b2.createPoints('',[-2.91, 2.51],'#2196f3')
...
b3.createPoints('',[0.29, 3.5],'#2196f3')
b3.createPoints('',[0.27, 3.7],'#2196f3')
b3.createPoints('',[3.59, 0.30],'#2196f3')
b3.createPoints('',[3.7, 0.30],'#2196f3')
...
b4.createPoints('',[3.08, 1.30],'#2196f3')
b4.createPoints('',[3.18, 1.43],'#2196f3')
b4.createPoints('',[3.29, 1.55],'#2196f3')
b4.createPoints('',[0.18, -3.17],'#2196f3')
b4.createPoints('',[0.16,-3.39],'#2196f3')
b4.createPoints('',[0.13, -3.61],'#2196f3')
const b5 = new Boards()
b5.createBoard(),'#2196f3'
