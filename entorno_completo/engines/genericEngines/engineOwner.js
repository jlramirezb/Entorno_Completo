        ...
        switch (el.type) {
          case 10: // en caso de ser 10 agregara la cantidad de boards con sus correspondientes dataset
            ...
            el.contents.forEach((element) => {
              contentArtiacts += `
                                   <div class='borderDefault fixed-content' style="margin:8px;">
  ...
  for (let key in definition.contents) {
    ...
    if (definition.contents[key].hasOwnProperty('header')) {
      ...
      header.forEach((element) => {
        ...
        const headerCellText = document.createElement('p');
        headerCellText.textContent = element;
        headerCell1.appendChild(headerCellText);
      ...
      if (definition.interactive) {
        templateClone.setAttribute('style', 'border: 1px solid var(--azulMedio); border-radius:40pxs; width:fit-content');
    ...
    if (Array.isArray(element[1])) {
      ...
      aux = auxValidation.some((vElement) => {
        ...
        if (typeof vElement == 'string') {
          ...
          // console.log("HOLAAA",gInterPoint(calculated, vElement, noiseValue))
