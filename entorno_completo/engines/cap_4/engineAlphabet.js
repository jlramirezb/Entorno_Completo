...
class EngineAlpabeth extends EngineMaker {
    ...
    diagramController() {
        if (!this.condition.defaultValue) {
            ...
            this.opacityInputs(this.bottomRounded, this.parY, this.parX, this.buttonPoint, this.buttonCreateCurve)
            this.diagramEvents()
            return
        }
    ...
    touchTop() {
        this.topRounded.firstElementChild.addEventListener("click", (event) => {
            ...
            this.opacityInputs(this.bottomRounded)
        })

    }

    touchBottom() {
        this.bottomRounded.firstElementChild.addEventListener("click", () => {
    ...
    pointButton() {
        this.buttonPoint.addEventListener("click", () => {
            ...
            this.opacityInputs(this.bottomRounded, this.parY, this.parX, this.buttonPoint);
            ...
            if (this.resolution.flat().length == xCoords.flat().length) {
                ...
                this.opacityInputs(this.topRounded, this.key, this.buttonCreateCurve)
            }
        })
    ...
    pointCreate(coordX, coordY) {
        ...
        this.coordPoints.push(gAllPointsDefault({
            def: this.definition,
            board: this.boardObject,
            points: [{
                x: coordX,
    ...
    reset() {
        this.buttonReset.addEventListener("click", () => {
            ...
            this.opacityInputs(this.topRounded, this.key,)
    ...
    cleanData() {
        const data = {
            ...
            elementArtifact: { points:[] /*this.coordPoints*/ },
        };
